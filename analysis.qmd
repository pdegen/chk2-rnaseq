...
print(nrow(go))
print(nrow(go[go$FDR.Down<FDR_thresh_ora, ]))
print(nrow(go[go$FDR.Up<FDR_thresh_ora, ]))
```
### KEGG
...
print(nrow(kegg))
print(nrow(kegg[kegg$FDR.Down<FDR_thresh_ora, ]))
print(nrow(kegg[kegg$FDR.Up<FDR_thresh_ora, ]))
```
## Session Info
